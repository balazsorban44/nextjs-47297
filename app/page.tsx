...
export default function Home() {
  return (
    <div>
      ...
      <p>
        Reloading and pressing the "Go to another page" link and then going to the
        blog post does work however, suggesting the issue is navigating from <code>/blog</code> to <code>/blog/a-post</code> (<code>/[slug]</code> where slug is blog and <code>/blog/[slug]</code> where slug is a-post)
      </p>
